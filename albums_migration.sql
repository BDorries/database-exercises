...
CREATE TABLE albums (
    ...
    release_year int(4) NOT NULL DEFAULT 9999,
    sales decimal(12,6) NOT NULL DEFAULT 0.000000,
    genre varchar(1024) NOT NULL DEFAULT 'Unknown',
    PRIMARY KEY (id)
);

INSERT INTO albums (artist, album_name, release_year, sales, genre) VALUES
...
('Led Zeppelin',	'Led Zeppelin IV',	1971,	30.400000,	'Hard rock, heavy metal, folk rock'),
('Michael Jackson',	'Bad',	1987,	21.100000,	'Pop, rhythm and blues, funk'),
...
('The Beatles',	'Sgt. Peppers Lonely Hearts Club Band',	1967,	18.300000,	'Rock'),
('Michael Jackson',	'Dangerous',	1991,	17.000000,	'New jack swing, R&B and pop'),
('The Beatles',	'Abbey Road',	1969,	16.800000,	'Rock'),
('Michael Jackson',	'Thriller2',	1900,	2.000000,	'stuff');
